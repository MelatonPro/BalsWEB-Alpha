...
class MemeChromium(QMainWindow):
    def __init__(self):
        ...
        # Central Widget: Tabs for Multiple Pages
        self.tabs = QTabWidget()
        self.tabs.setDocumentMode(True)  # Chromium-style tabs
    ...
    def new_tab(self, *args):
        ...
        browser.setUrl(QUrl("https://melaton.pro/balsweb/newtab"))  # Default page
    ...
    def go_home(self):
        self.current_browser().setUrl(QUrl("https://example.com"))
